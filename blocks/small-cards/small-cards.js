...
function getMediaHTML(data) {
  ...
  if (mediaType === 'noise_canceling') {
    ...
    content = `
            <div class="wditems__content wditems__content__0 theme-white ai__noise__container" id="SectionID-tab-1" style="${style} background-color: var(--ai-noise-container-bg);">

...
const loadConfig = async () => {
  ...
  try {
    ...
    // Why use asusCto? To prevent CTO-specific resources from failing to load when accessed from other non-CTO domains.
    // let realDomain =window.asusCto?window.asusCto.baseUrl:'';
